...
PARAM  <- list()
PARAM$dataset  <- "./datasets/competencia_2023_.csv.gz"
PARAM$experimento  <- "CA6050"

PARAM$home_directory  <- "X:\\gdrive\\ITBA2023dmBC\\"
...
for( campo in  campos_buenos )
{
  ...
  abline(v=c(06), col=c("green","green","green"), lty=c(1), lwd=c(1))
  abline(v=c(11), col=c("green","green","green"), lty=c(3), lwd=c(1))
}
